Analyze this unit's vocabulary and group into themes.

# Setup

- **Grade**: Grade 7 (初一上)
- **Textbook**: {{textbook}}
- **Unit**: {{unit_number}} — {{unit_title_en}} / {{unit_title_zh}}
- **Audience**: 13-year-old Chinese girl, loves Identity V game
